...
const ghostIntroduction = `A Ghost is an evil spirit of a dead person that feeds off peoples' fear. They are created from violent, sudden deaths. If disturbed they can wreck havoc across neighbourhoods and they have also been known to be up to 1000 years old. This guide will help you understand what you need to survive. Evidence of the supernatural is high in demand which means it can sell. Hunting ghosts however is an extremely dangerous task. It will be your job to enter locations and gather as much evidence of the supernatural as possible, just remember, don't outstay your welcome. In order to discover what type of ghost you are dealing with, you will have to learn each ghost's strengths and weaknesses.`;
const huntersSanity = `In your investigation into the supernatural, you will need to make sure your sanity is kept high. All types of ghosts prey on our sanity making them stronger the more insane we become. To keep your sanity high around the paranormal, make sure you stay in lit areas. The digital clock in the truck shows you how long you have before the ghost will get angry and lower your sanity faster, use this time to find the ghost and setup equipment. If your sanity becomes too low, the recommended action is to leave.`;
const smudging = `This has always been one of the main ways to weaken the more common ghosts. To do this you will need to grab some smudge sticks and burn it near the ghost.`;
const ghostWriting = `Paranormal investigators started using pen and paper as an alternative form of communication to the spirit box. It was later discovered that only certain types of ghosts will write.`;
const ouijaBoard = `The most common way of accidentally summoning a ghost is with a ouija board, so you may come across these during your investigations. Be careful if you choose to use it as they have been known to lower your sanity. To use one, activate it and then ask a question with your voice.`;
const emfLevel5 = `Some ghosts will leave emf traces near them that will show up on an EMF reader as level 5.`;
const spiritBox = `Only certain ghosts will talk through a spirit box when asked a question with your voice. Make sure the lights are off.`;
const freezingTemperaturs = `All ghosts make areas cold, however some ghosts have been known to drop temperatures even further.`;
const fingerprints = `Some ghosts have been known to leave fingerprints on doors, windows, and light switches. This will show up with a UV light.`;
